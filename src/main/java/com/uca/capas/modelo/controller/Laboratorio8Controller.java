...
public class Laboratorio8Controller {
	...
	public ModelAndView ejecutarAlmacenamiento(@RequestParam Integer cliente, @RequestParam Boolean estado) {
		ModelAndView mav = new ModelAndView();
		Integer resultado;
	...
	public ModelAndView insercionBatch() throws ParseException{
		...
		logger.log(Level.INFO, "Duracion del metodo -> {0} milisegundos");
		mav.setViewName("Laboratorio/resultado");
		return mav;
